...
namespace GUILLMZ\GoogleMerchantApi\Contents\Product;

use GUILLMZ\GoogleMerchantApi\Contents\BaseContent;
use Closure;
use Carbon\Carbon;
use GUILLMZ\GoogleMerchantApi\Contents\Price;
use GUILLMZ\GoogleMerchantApi\Contents\Measure;
use GUILLMZ\GoogleMerchantApi\Contents\Taxes;
...
class Product extends BaseContent
{
     ...
     * @throws GUILLMZ\GoogleMerchantApi\Exceptions\ProductContentAttributesUndefined
     */
    public function with($attributes){

        if( !($attributes_map = config('laravel-google-merchant-api.contents.products.attributes')) ){
            throw new \GUILLMZ\GoogleMerchantApi\Exceptions\ProductContentAttributesUndefined;
        }
    ...
    public function price($price, $currency = null)
    {
        if(is_numeric($price) || is_string($price)){
            ...
            throw new \GUILLMZ\GoogleMerchantApi\Exceptions\InvalidPriceInput;
        }
    ...
    public function shipping($shipping)
    {
        if(is_array($shipping)){
            ...
            throw new \GUILLMZ\GoogleMerchantApi\Exceptions\InvalidProductShippingInput;
        }
    ...
    public function shippingHeight($shippingHeight, $unit = 'cm')
    {
        if(is_numeric($shippingHeight)){
            ...
            throw new \GUILLMZ\GoogleMerchantApi\Exceptions\InvalidMeasureInput;
        }
    ...
    public function taxes($tax)
    {
        ...
        elseif(!($tax instanceof Taxes)){
            throw new \GUILLMZ\GoogleMerchantApi\Exceptions\InvalidTaxInput;
        }
